        ...
        <fieldset>
            ...
            <form action="actions/a_update.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    ...
                    <th>Description</th>
                        <td><input class="form-control" type="text"  name="description" placeholder ="Add a description" value="<?php echo $description ?>"  /></td>
                    </tr>
                    <tr>
                        <th>Price</th>
                    ...
                    <tr>
                        ...
                        <td><a href= "../Login/dashBoard.php"><button class="btn btn-warning" type="button">Back</button></a></td>
                    </tr>
                </table>
            </form>
        </fieldset>
